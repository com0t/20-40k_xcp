...
! defined( 'WOOSQ_VERSION' ) && define( 'WOOSQ_VERSION', '2.8.1' );
		...
		if ( ! class_exists( 'WPCleverWoosq' ) ) {
			class WPCleverWoosq {
				...
				function __construct() {
					...
					add_action( 'admin_enqueue_scripts', array( $this, 'woosq_admin_enqueue_scripts' ) );
				...
				function woosq_admin_enqueue_scripts( $hook ) {
